...
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_CMS_TECHNICAL_DESIGN_REPORT_VOLUME_II_PHYSICS_PERFORMANCE.pdf}
\subsubsection{OFFLINE CALIBRATION PROCEDURE OF THE CMS DRIFT TUBE DETECTORS}
Documentación aportada en la página web
%\includepdf[pages={1,2}]{Articulos/Investigacion_Publicaciones_OFFLINE_CALIBRATION_PROCEDURE_OF_THE_CMS_DRIFT_TUBE_DETECTORS.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2}]{Articulos/Investigacion_Publicaciones_MOTIONS_OF_CMS_DETECTOR_STRUCTURES_DUE_TO_THE_MAGNETIC_FIELD_FORC.pdf}
\subsubsection{CMS MUON ALIGNMENT SYSTEM DESCRIPTION AND FIRST RESULTS}
Documentación aportada en la página web
%\includepdf[pages={1,2}]{Articulos/Investigacion_Publicaciones_CMS_MUON_ALIGNMENT_SYSTEM_DESCRIPTION_AND_FIRST_RESULTS.pdf}
\subsubsection{ALIGNING THE CMS MUON CHAMBERS WITH THE MUON ALIGNMENT SYSTEM DURING AN EXTENDED COSMIC RAY RUN}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_ALIGNING_THE_CMS_MUON_CHAMBERS_WITH_THE_MUON_ALIGNMENT_SYSTEM_DUR.pdf}
\subsubsection{ALIGNMENT OF THE CMS MUON SYSTEM WITH COSMIC-RAY AND BEAM-HALO MUONS}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_ALIGNMENT_OF_THE_CMS_MUON_SYSTEM_WITH_COSMIC-RAY_AND_BEAM-HALO_MU.pdf}
\subsubsection{CMS DATA PROCESSING WORKFLOWS DURING AN EXTENDED COSMIC RAY RUN}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_CMS_DATA_PROCESSING_WORKFLOWS_DURING_AN_EXTENDED_COSMIC_RAY_RUN.pdf}
\subsubsection{CALIBRATION OF THE CMS DRIFT TUBE CHAMBERS AND MEASUREMENT OF THE DRIFT VELOCITY WITH COSMIC RAYS}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_CALIBRATION_OF_THE_CMS_DRIFT_TUBE_CHAMBERS_AND_MEASUREMENT_OF_THE.pdf}
\subsubsection{COMMISSIONING OF THE CMS EXPERIMENT AND THE COSMIC RUN AT FOUR TESLA}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_COMMISSIONING_OF_THE_CMS_EXPERIMENT_AND_THE_COSMIC_RUN_AT_FOUR_TE.pdf}
\subsubsection{PERFORMANCE OF CMS MUON RECONSTRUCTION IN COSMIC-RAY EVENTS}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_PERFORMANCE_OF_CMS_MUON_RECONSTRUCTION_IN_COSMIC-RAY_EVENTS.pdf}
\subsubsection{PERFORMANCE OF THE CMS DRIFT TUBE CHAMBERS WITH COSMIC RAYS}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_PERFORMANCE_OF_THE_CMS_DRIFT_TUBE_CHAMBERS_WITH_COSMIC_RAYS.pdf}
\subsubsection{PRECISE MAPPING OF THE MAGNETIC FIELD IN THE CMS BARREL YOKE USING COSMIC RAYS}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_PRECISE_MAPPING_OF_THE_MAGNETIC_FIELD_IN_THE_CMS_BARREL_YOKE_USIN.pdf}
\subsubsection{MEASUREMENT OF THE CHARGE RATIO OF ATMOSPHERIC MUONS WITH THE CMS DETECTOR}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_MEASUREMENT_OF_THE_CHARGE_RATIO_OF_ATMOSPHERIC_MUONS_WITH_THE_CMS.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_SEARCH_FOR_PHYSICS_BEYOND_THE_STANDARD_MODEL_IN_OPPOSITE-SIGN_DIL.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_physics_with_same-sign_isolated_dilepton_events_wi.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_A_New_Boson_With_A_Mass_Of.pdf}
\subsubsection{SEARCH FOR SUPERSYMMETRY IN HADRONIC FINAL STATES USING MT2 IN PP COLLISIONS AT 7 TEV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_SEARCH_FOR_SUPERSYMMETRY_IN_HADRONIC_FINAL_STATES_USING_MT2_IN_PP.pdf}
\subsubsection{SEARCH FOR PHYSICS BEYOND THE STANDARD MODEL IN EVENTS WITH A Z BOSON JETS AND MISSING TRANSVERSE ENERGY}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_SEARCH_FOR_PHYSICS_BEYOND_THE_STANDARD_MODEL_IN_EVENTS_WITH_A_Z_B.pdf}
\subsubsection{Observation of a new boson at a mass of 125 GeV with the CMS experiment at the LHC}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Observation_of_a_new_boson_at_a_mass.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_physics_in_events_with_same-sign_dileptons_and_b-t.pdf}
\subsubsection{Performance of CMS Muon Reconstruction in pp Collision Events at sqrt s 7 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Performance_of_CMS_Muon_Reconstruction_in_pp_Collision_Events_at_.pdf}
\subsubsection{INTERPRETATION OF SEARCHES FOR SUPERSYMMETRY WITH SIMPLIFIED MODELS}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_INTERPRETATION_OF_SEARCHES_FOR_SUPERSYMMETRY_WITH_SIMPLIFIED_MODE.pdf}
\subsubsection{SEARCH FOR NEW PHYSICS IN EVENTS WITH SAME-SIGN DILEPTONS AND B JETS IN PP COLLISIONS at 8 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_SEARCH_FOR_NEW_PHYSICS_IN_EVENTS_WITH_SAME-SIGN_DILEPTONS_AND_B_J.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_SEARCH_FOR_NEW_PHYSICS_IN_EVENTS_WITH_OPPOSITE-SIGN_LEPTONS_JETS_.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_Supersymmetry_in_Events_with_Opposite-Sign_Dileptons_a.pdf}
\subsubsection{Search for new physics in events with same-sign dileptons and jets in pp collisions at sqrt s 8 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_physics_in_events_with_same-sign_dileptons_and_jet.pdf}
\subsubsection{Searches for Supersymmetry using the MT2 Variable in Hadronic Events Produced in pp Collisions at 8 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Searches_for_Supersymmetry_using_the_MT2_Variable_in_Hadronic_Eve.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_Physics_Beyond_the_Standard_Model_in_Events_with_Two_L.pdf}
...
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_supersymmetry_in_the_multijet_and_missing_transverse_m.pdf}
Documentación aportada en la página web
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_physics_with_the_MT2_variable_in_all-jets_final_st.pdf}
\subsubsection{Inclusive search for supersymmetry using razor variables in pp collisions at  sqrt s 13 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Inclusive_search_for_supersymmetry_using_razor_variables_in_pp_co.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_supersymmetry_in_pp_collisions_at_sqrt_s_13_TeV_in_the.pdf}
\subsubsection{Search for new physics in same-sign dilepton events in proton–proton collisions at sqrt s 13 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_physics_in_same-sign_dilepton_events_in_proton_p.pdf}
\subsubsection{Phenomenological MSSM interpretation of CMS searches in pp collisions at sqrt s 7 and 8 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Phenomenological_MSSM_interpretation_of_CMS_searches_in_pp_collis.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_physics_in_final_states_with_two_opposite-sign_sam.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_direct_production_of_supersymmetric_partners_of_the_to.pdf}
\subsubsection{Search for top squark pair production in pp collisions at sqrt s 13 TeV using single lepton events}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_top_squark_pair_production_in_pp_collisions_at_sqrt_s_.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_phenomena_with_the_MT2_variable_in_the_all-hadroni.pdf}
...
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_supersymmetry_in_multijet_events_with_missing_transver.pdf}
Documentación aportada en la página web
\subsubsection{Search for Supersymmetry in pp Collisions at sqrt s 13 TeV in the Single-Lepton Final State Using the Sum of Masses of Large-Radius Jets}
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_Supersymmetry_in_pp_Collisions_at_sqrt_s_13_TeV_in_the.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_electroweak_production_of_charginos_and_neutralinos_in.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_A_search_for_new_phenomena_in_pp_collisions_at_sqrt_s_13_TeV_in_f.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_new_phenomena_in_final_states_with_two_opposite-charge.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Searches_for_pair_production_of_charginos_and_top_squarks_in_fina.pdf}
\subsubsection{Non-destructive testing of industrial equipment using muon radiography}
Documentación aportada en la página web
%\includepdf[pages={1,2}]{Articulos/Investigacion_Publicaciones_Non-destructive_testing_of_industrial_equipment_using_muon_radiog.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_the_pair_production_of_third-generation_squarks_with_t.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_electroweak_production_of_charginos_and_neutralinos_in_2.pdf}
\subsubsection{Search for supersymmetry in proton-proton collisions at sqrt s 13 TeV using identified top quarks}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_supersymmetry_in_proton-proton_collisions_at_sqrt_s_13.pdf}
\subsubsection{Search for top squarks and dark matter particles in opposite-charge dilepton final states at sqrt s 13 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_top_squarks_and_dark_matter_particles_in_opposite-char.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_supersymmetry_in_events_with_a_tau_lepton_pair_and_mis.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Combined_search_for_electroweak_production_of_charginos_and_neutr.pdf}
\subsubsection{Search for dark matter particles produced in association with a top quark pair at sqrt s 13 TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_dark_matter_particles_produced_in_association_with_a_t.pdf}
\subsubsection{Search for supersymmetric partners of electrons and muons in proton–proton collisions at sqrt s 13TeV}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_supersymmetric_partners_of_electrons_and_muons_in_prot.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_the_pair_production_of_light_top_squarks_in_the_emu_fi.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_For_Supersymmetry_In_Final_States_with_two.pdf}
\subsubsection{Estimation of snow water equivalent using muon scattering radiography}
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Estimation_of_the_Snow_Water_Equivalent.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Search_for_top_squarks_in_the_four_body.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_Improving_detection_of.pdf}
...
Documentación aportada en la página web
%\includepdf[pages={1,2,3}]{Articulos/Investigacion_Publicaciones_An_end_to_end_computer.pdf}


\subsection{Publicaciones científicas no indexadas en JCR}

\subsubsection{Muon Reconstruction in the CMS Detector}
\includepdf[pages={1,2}]{ArticulosNoJCR/Investigacion_PublicacionesNoJCR_Muon_Reconstruction_in_the_CMS.pdf}
...
%\includepdf[pages={1,2,3,4,5}]{Libros/Investigacion_Libros_Muon_Imaging.pdf}
Documentación aportada en la página web

\subsubsection{Artificial intelligence, robotics and data science}
%\includepdf[pages={1,2,3,4,5}]{Libros/Investigacion_Libros_Artificial_Intelligence.pdf}
Documentación aportada en la página web
...
%\includepdf[pages=-]{Conferencias/Investigacion_Congresos_Role_Of_The_AI.pdf}
Documentación aportada en la página web

\subsubsection{Muography applications to the industrial sector}
%\includepdf[pages=-]{Investigacion_Congresos_Application_Of_Muography_to_industrial.pdf}
Documentación aportada en la página web

\subsubsection{Ultra-fast muon tomography simulations using Adversarial Neural Networks}
%\includepdf[pages=-]{Conferencias/Investigacion_Congresos_Ultra_Fast_Muon.pdf}
Documentación aportada en la página web
...
%\includepdf[pages=-]{Conferencias/Investigacion_Congresos_Use_Of_Machine.pdf}
Documentación aportada en la página web
...
Documentación aportada en la página web
%\includepdf[pages=-]{Proyectos/Investigacion_Proyectos_Integracion_Y_Validacion_Experimental.pdf}

\subsubsection{CENTRO DE PROCESADO DE DATOS DE CMS TIER-2 EN EL IFCA}
Documentación aportada en la página web
%\includepdf[pages=-]{Proyectos/Investigacion_Proyectos_CENTRO_DE_PROCESADO_DE_DATOS_DE_CMS_TIER2.pdf}

\subsubsection{Actividades del IFCA para los upgrades de alta luminosidad del LHC: Inner Tracker y Endcap Timing Layer}
Documentación aportada en la página web
%\includepdf[pages=-]{Proyectos/Investigacion_Proyectos_Actividades_del_IFCA_para_los_upgrades.pdf}
...
Documentación aportada en la página web
%\includepdf[pages=-]{Proyectos/Investigacion_Proyectos_Algoritmia_Simulacion_Rapida.pdf}
...
\includepdf[pages=-]{InvestigacionOtrosMeritos/Investigacion_OtrosMeritosCalidadInvestigadora_PuestosDeResponsabilidad2.pdf}
...
\includepdf[pages=-]{InvestigacionOtrosMeritos/Investigacion_OtrosMeritosCalidadInvestigadora_Referee_EPJC2.pdf}

\subsection{Referee de Scientific Reports}
\includepdf[pages=-]{InvestigacionOtrosMeritos/Investigacion_OtrosMeritosCalidadInvestigadora_Referee_ScientificReports.pdf}
...
\includepdf[pages=-]{InvestigacionOtrosMeritos/Investigacion_OtrosMeritosCalidadInvestigadora_Paneles_Evaluacion_Argentina.pdf}

\subsection{Certificado de sexenios de investigación}
\includepdf[pages=-]{InvestigacionOtrosMeritos/Investigacion_OtrosMeritosCalidadInvestigadora_Sexenios.pdf}

\subsection{Acreditacion I3}
\includepdf[pages=-]{Acreditaciones/AcreditacionI3Completa.pdf}
...
\subsubsection{Profesor asistente en la ETH Zurich (2010-2017)}
...
%\includepdf[pages=-]{Docencia/Docencia_PuestosOcupados_RamonYCajal-PTU-Unican-2017-presente.pdf}
Documentación aportada en la página web

\subsubsection{Profesor titular en la universidad de cantabria 2023-2024}
%\includepdf[pages=-]{Docencia/Docencia_PuestosOcupados_Unican_2023-2024.pdf
Documentación aportada en la página web
...
%\includepdf[pages=-]{Docencia/Docencia_TesisDoctorales_Busqueda_de_materia_oscura1.pdf}
Documentación aportada en la página web.
\subsubsection{Búsqueda de materia oscura en asociación con quarks top en el estado final dileptónico a sqrt(13) TeV}
%\includepdf[pages=-]{Docencia/Docencia_TesisDoctorales_Busqueda_de_materia_oscura2.pdf}
Documentación aportada en la página web.
...
%\includepdf[pages=-]{Docencia/Docencia_TesisDoctorales_long_lived.pdf}
Documentación aportada en la página web.
...
%\includepdf[pages=-]{Docencia/Docencia_TesisDoctorales_Tomografia.pdf}
Documentación aportada en la página web.
...
\includepdf[pages=-]{Docencia/Docencia_OtrosMeritos_TesisDirigida_TesisDirigidasActualmente.pdf}

\subsubsection{Reconocimiento de tramos docentes}
\includepdf[pages=-]{Acreditaciones/QuinqueniosYSexenios.pdf}
...
\includepdf[pages=-]{Docencia/Docencia_Formacion_curso_comunicacion_efectiva.pdf}

\subsubsection{Curso de implementación práctica de estrategias de innovación docente}
\includepdf[pages=-]{Docencia/Docencia_Formacion_curso_implementacion_practica.pdf}
...
\includepdf[pages=-]{Transferencia/Transferencia_Articulo83_Proyecto_Muon_Systems2.pdf}
...
\includepdf[pages=-]{Transferencia/Transferencia_Articulo83_Proyecto_poblacion.pdf}
