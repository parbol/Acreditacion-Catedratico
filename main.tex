...
\includepdf[pages=-]{A proposal of standard model background requests for the SUSY group}

\subsubsection{}
\includepdf[pages=-]{Overview of the TBT group}
\subsubsection{}
\includepdf[pages=-]{The TBT plans for legacy and plans for combinations}
\subsubsection{}
\includepdf[pages=-]{Role of the AI in the industrial applications of Muography}
\subsubsection{}
\includepdf[pages=-]{Muography applications to the industrial sector}
\subsubsection{}
\includepdf[pages=-]{Ultra-fast muon tomography simulations using Adversarial Neural Networks}
\subsubsection{}
\includepdf[pages=-]{Use of Generative Adversarial Neural Networks in Muography}
\subsubsection{}
\includepdf[pages=-]{Use of Machine Learning techniques for muography applied to industrial applications}
